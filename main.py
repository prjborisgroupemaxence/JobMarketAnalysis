...
def main():
    ...
    if pre_process:
        # Preprocessing
        x_train, x_test, y_train, y_test, X_pred_gd, dnan, df = pre_processing(cleaned_df)

    if model:
        # Modelization
        predict_krbf, predict_rf = make_model(x_train, x_test, y_train, y_test, X_pred_gd, dnan)
